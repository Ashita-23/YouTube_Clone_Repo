...
//  
   return( <div className="border border-blue-800 w-[100%] px-0 py-0 mt-16 h-[100%] sm:">
    ...
    scrollbar-w-thin scrollbar-rounded-full items-center scrollbar-thumb-gray-600 scrollbar-track-gray-200  snap-x sm:w-[100%]">
            ...
            }  } key={Math.random()*2 }>{Btn_text}</button>) }
    </div>
