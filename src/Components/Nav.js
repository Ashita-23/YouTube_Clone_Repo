...
const Navigation = ()=>{
    return(<div className="flex justify-around bg-white p-2 drop-shadow-md" >
            ...
            <span  className="text-xl px-3 py-2  border border-black-200 rounded-r-full mr-2 bg-gray-100 hover:bg-gray-300" ><i class="fa-solid fa-magnifying-glass"></i></span>
